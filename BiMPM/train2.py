...
training = get_data('../repo/datasets/snli/snli_1.0/snli_1.0_train.jsonl')
...
char_tokenizer = preprocessing.LabelEncoder()
char_tokenizer.fit(training[0] + training[1])
...
if not os.path.exists(GLOVE_STORE + '.npy'):
    ...
    embeddings_index = {}
    f = open('../repo/datasets/embeddings/glove/glove.6B.300d.txt')
    for line in f:
      values = line.split(' ')
      word = values[0]
